...
import { TextObject } from './MemeEditor'
...
const MemeCanvas = forwardRef<HTMLCanvasElement, MemeCanvasProps>(
  ({ image, texts, onScaleUpdate }, ref) => {
    ...
    const wrapText = (ctx: CanvasRenderingContext2D, text: TextObject, maxWidth: number) => {
    ...
    const drawText = (ctx: CanvasRenderingContext2D, text: TextObject) => {
      ctx.font = `${text.font_size}px ${text.font_family}`
